function [binval,upper,lower,Lhat]= pandit_point_cross_L_test( InMat2, numbin2, numsim, R )
...
[binval,L] = pandit_point_cross_K_function(InMat2, numbin2, R,highest);
...
[binval2(i,:),Lsim(i,:)] = pandit_point_cross_K_function(InMat3,numbin2,R,highest);
